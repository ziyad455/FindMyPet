...
export const RegisterPage: React.FC = () => {
  ...
  const getPasswordStrength = () => {
    ...
    if (password.length < 6) return { width: '33%', color: 'bg-red-500', label: t('auth.passwordWeak') };
    if (password.length < 10) return { width: '66%', color: 'bg-yellow-500', label: t('auth.passwordMedium') };
    return { width: '100%', color: 'bg-green-500', label: t('auth.passwordStrong') };
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-50 rounded-full blur-3xl opacity-50 -translate-x-1/2 translate-y-1/2" />
      </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                {/* Match indicator */}
                {confirmPassword && (
                  <div className={`absolute inset-y-0 right-12 flex items-center pr-2 ${password === confirmPassword ? 'text-green-500' : 'text-red-500'}`}>
